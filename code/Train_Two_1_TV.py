...
def get_data(name):
    ...
    data = []
    for t in tmp:
        t['label'] = {'Medical Non-instructional':0,'Non-medical':1,'Medical Instructional':0}[t['label']]
...
from deberta import DebertaV2ForCL
model = DebertaV2ForCL.from_pretrained(CFG['model'],num_labels = 2)  # 模型
